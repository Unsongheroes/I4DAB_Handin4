...
namespace ProsumerInfo.Migrations
{
    ...
    [Migration("20180520174048_cascadeDeleteForSmartMeterTryFive")]
    partial class cascadeDeleteForSmartMeterTryFive
    {
            ...
            modelBuilder.Entity("ProsumerInfo.Models.SmartMeter", b =>
                {
                    ...
                    b.Property<int>("ProsumerForeignKey");
            ...
            modelBuilder.Entity("ProsumerInfo.Models.SmartMeter", b =>
                {
                    b.HasOne("ProsumerInfo.Models.Prosumer", "Prosumer")
                        .WithOne("SmartMeter")
                        .HasForeignKey("ProsumerInfo.Models.SmartMeter", "ProsumerForeignKey")
