...
namespace ProsumerInfo.Migrations
{
    ...
    [Migration("20180520180432_cascadeDeleteForSmartMeterTrySix")]
    partial class cascadeDeleteForSmartMeterTrySix
    {
            ...
            modelBuilder.Entity("ProsumerInfo.Models.Prosumer", b =>
                {
                    ...
                    b.HasIndex("SmartMeterId")
                        .IsUnique()
                        .HasFilter("[SmartMeterId] IS NOT NULL");
            ...
            modelBuilder.Entity("ProsumerInfo.Models.Prosumer", b =>
                {
                    b.HasOne("ProsumerInfo.Models.SmartMeter", "SmartMeter")
                        .WithOne()
                        .HasForeignKey("ProsumerInfo.Models.Prosumer", "SmartMeterId")
